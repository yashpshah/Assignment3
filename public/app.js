...
class ProductRow extends React.Component {
  render() {
    ...
    return React.createElement("tr", null, React.createElement("td", null, product.id), React.createElement("td", null, product.Name), React.createElement("td", null, "$", product.Price), React.createElement("td", null, product.Category), React.createElement("td", null, React.createElement("a", {
      href: product.Image,
      target: "_blank"
    }, "View")));
  }
